...
import { PressableScale, type AnimationConfig } from '@/components/craft-ui/PressableScale';
...
type BaseProps = {
   ...
   * @param props.animatedStyle - The animated style object containing the color animation.
   */
  renderIcon: (props: { iconSize: number; iconColor: string; animatedStyle: StyleProp<TextStyle> }) => ReactElement;
  /**
...
export const AnimatedIcon = Animated.createAnimatedComponent(Ionicons);
    ...
    <PressableScale
      ...
      <Animated.View key={`button-bg-${UnistylesRuntime.themeName}`} style={[styles.button({ size, disabled }), backgroundStyle]}>
        ...
        {renderContent({
          ...
          iconColor: colorConfig.textUnpressed,
